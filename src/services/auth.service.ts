...
//         const sellerRole = await roleRepository.getByName(RoleEnum.SELLER);
//
...
//             roles: [sellerRole._id], // роль продавця
//             accountType: dto.accountType, // base або premium
//             isVerified: false,
//             isDeleted: false,
//         });
//
...
//         const tokens = tokenService.generateTokens({
//             userId: user._id.toString(),
//             roles: [RoleEnum.SELLER], // для middleware
//             name: user.name,
//             email: user.email,
//         });
//
...
// //         const hashedPassword = await passwordService.hashPassword(dto.password);
// //
// //         // Створюємо користувача з роллю SELLER
// //         const user = await userRepository.create({
// //             name: dto.name,
// //             email: dto.email,
// //             password: hashedPassword,
