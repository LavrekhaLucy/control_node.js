...
// import {IChangePassword, IResetPasswordSend, IResetPasswordSet, ISignIn} from '../interfaces/user-interface';
//
//
...
//             const { user, tokens } = await authService.signUp({ name, email, password, accountType });
